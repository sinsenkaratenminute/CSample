...
namespace AnimalPolymorphismSample
{
    public partial class Form1 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            textBox4.Text = cat1.WrapChocolate();   // 動物クラスのインスタンス.WrapChocolate() でトッピングを表示
            textBox5.Text = dog1.WrapChocolate();   // 動物クラスのインスタンス.WrapChocolate() でトッピングを表示
            textBox6.Text = bird1.WrapChocolate();  // 動物クラスのインスタンス.WrapChocolate() でトッピングを表示
        }
    }
}
